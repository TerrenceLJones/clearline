 ...
 * `ModalShell` so focus-trap, Escape-to-close and ARIA come from the design system; closing it without a
      ...
      {isNetwork ? (
        <>
          ...
          <div className="flex gap-2.25">
            ...
            <Button className="flex-[1.5]" fullWidth loading={isVerifying} onClick={() => submit()}>
              Try again
            </Button>
          </div>
        ...
        <>
          ...
          <ModalShell.Description asChild>
            <Text as="p" size="label" tone="muted" className="mb-4 leading-relaxed">
              Enter the {otpLength}-digit code sent to {destinationMasked}. Required for transfers
              over {thresholdLabel}.
            </Text>
          </ModalShell.Description>
